...
**Working with:** SQL · dbt · BigQuery · Looker / LookML · Python · Fivetran · Airflow
· Snowflake · Google ADK · Gemini · Claude API

**A few things I've built:**
- 🌉 **[GoldenGate Retail AI](https://github.com/heemaniar/goldengate-retail-ai)** — multi-agent
  AI co-pilot for Bay Area mall GMs; routes questions to 3 specialist agents over ~1.5M synthetic
  transactions across 13 malls, every answer traceable to the SQL (Google ADK · Gemini 3 Flash ·
...
- ⚙️ **[Operations Productivity Intelligence](https://github.com/heemaniar/ops-productivity-intelligence)**
  ...
  patterns with ML and Claude and benchmarks a classic ML classifier against an LLM for triage
  (measured a 24% handle-time drop on KB-addressable tickets).

📍 San Francisco Bay Area · 📫 maniarheema@gmail.com ·
💼 [LinkedIn](https://www.linkedin.com/in/heema-maniar/) ·
🌐 [Portfolio](https://heemaniar.github.io)
